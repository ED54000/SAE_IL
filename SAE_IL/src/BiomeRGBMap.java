...
public class BiomeRGBMap {
    ...
    public BiomeRGBMap() {
        ...
        biomeMap.put("Désert", new int[]{237, 201, 175});
        biomeMap.put("Forêt tropicale", new int[]{34, 139, 34});
        biomeMap.put("Océan", new int[]{0, 105, 148});
        biomeMap.put("Toundra", new int[]{208, 216, 232});
        biomeMap.put("Savane", new int[]{189, 183, 107});
        biomeMap.put("Forêt tempérée", new int[]{34, 139, 34});
        biomeMap.put("Montagnes", new int[]{169, 169, 169});
        biomeMap.put("Prairie", new int[]{124, 252, 0});
        biomeMap.put("Zone urbaine", new int[]{169, 169, 169});
        biomeMap.put("Marais", new int[]{85, 107, 47});
        biomeMap.put("Taïga", new int[]{0, 100, 0});
        ...
        biomeMap.put("Glacier", new int[]{173, 216, 230});
